...
type Model struct {
	OperationalStatus string         `json:"operational_status" gorm:"size:24;not null;default:auto"`
	OperationalNotice string         `json:"operational_notice" gorm:"size:1120"`
	OperationalUntil  int64          `json:"operational_until" gorm:"not null;default:0"`
	Id                int            `json:"id"`
...
func (mi *Model) Update() error {
	...
	return DB.Model(&Model{}).Where("id = ?", mi.Id).
		Select("model_name", "description", "icon", "tags", "vendor_id", "endpoints", "status", "sync_official", "name_rule", "updated_time", "operational_status", "operational_notice", "operational_until").
		Updates(mi).Error
}
