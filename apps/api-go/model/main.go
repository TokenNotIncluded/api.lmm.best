...
func mainMigrationModels() []interface{} {
	return []interface{}{
		...
		&ReferralReward{}, &ReferralRewardEntry{}, &ReferralModerationOperation{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&ReferralRewardEntry{}, "ReferralRewardEntry"},
		{&ReferralModerationOperation{}, "ReferralModerationOperation"},
		{&QuotaData{}, "QuotaData"},
		{&Task{}, "Task"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
