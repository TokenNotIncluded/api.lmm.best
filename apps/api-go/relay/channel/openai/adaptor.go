...
import (
	...
	"github.com/LIghtJUNction/api.lmm.best/relay/channel/openrouter"
	"github.com/LIghtJUNction/api.lmm.best/relay/channel/xinference"
	relaycommon "github.com/LIghtJUNction/api.lmm.best/relay/common"
	"github.com/LIghtJUNction/api.lmm.best/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if (info.ChannelType == constant.ChannelTypeOpenAI || info.ChannelType == constant.ChannelTypeOpenHuman) && "" != info.Organization {
