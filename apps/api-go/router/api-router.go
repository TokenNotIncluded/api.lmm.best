...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/ai-directory/ads/mine", middleware.UserAuth(), controller.ListMyAIDirectoryAds)
		apiRouter.POST("/ai-directory/ads", middleware.UserAuth(), middleware.CriticalRateLimit(), middleware.RequestBodyLimit(8<<10), controller.CreateAIDirectoryAd)
		apiRouter.POST("/ai-directory/ads/:id/hide", middleware.RootAuth(), middleware.CriticalRateLimit(), controller.HideAIDirectoryAd)
		apiRouter.GET("/share/profile/:token", controller.GetPublicProfileShareSVG)
