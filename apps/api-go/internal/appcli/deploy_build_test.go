...
func writeBuildSourceFixture(t *testing.T, root string) {
	...
	files := map[string]string{
		...
		"packaging/common/lmm-api/edge-policy/nginx/http-map.conf":              "map $http_upgrade $connection_upgrade {}\n",
		"packaging/common/lmm-api/edge-policy/nginx/lmm-api-locations.conf":     "location / {}\n",
		"packaging/common/lmm-api/edge-policy/nginx/mime.types":                 "text/plain txt;\n",
		"packaging/common/lmm-api/edge-policy/nginx/new-api.conf":               "server {}\n",
		"packaging/common/lmm-api/edge-policy/nginx/lmm-api-region-policy.conf": "auth_request /internal/access-ip-policy;\n",
	}
