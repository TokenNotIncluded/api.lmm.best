...
pub(in crate::routes::assistant) struct FixtureResolveCall {
    pub(in crate::routes::assistant) admin_user_id: i64,
    pub(in crate::routes::assistant) admin_username: String,
    pub(in crate::routes::assistant) lead_id: i64,
    pub(in crate::routes::assistant) note: String,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(in crate::routes::assistant) struct FixtureSubmitCall {
    pub(in crate::routes::assistant) user_id: i64,
    pub(in crate::routes::assistant) username: String,
    pub(in crate::routes::assistant) message: String,
}

#[derive(Clone, Debug)]
pub(in crate::routes::assistant) struct FixturePrepareKeyCall {
    pub(in crate::routes::assistant) user_id: i64,
    pub(in crate::routes::assistant) session_id: String,
    pub(in crate::routes::assistant) draft: PreparedKeyDraft,
}

#[derive(Clone, Debug)]
pub(in crate::routes::assistant) struct FixtureConfirmKeyCall {
    pub(in crate::routes::assistant) actor_id: i64,
    pub(in crate::routes::assistant) session_id: String,
    pub(in crate::routes::assistant) expected_session_version: i64,
    pub(in crate::routes::assistant) expected_user_auth_version: i64,
    pub(in crate::routes::assistant) token: ConfirmationToken,
    pub(in crate::routes::assistant) two_factor_code: String,
}

#[derive(Clone)]
pub(in crate::routes::assistant) struct FixtureStore {
    pub(in crate::routes::assistant) settings: AssistantSettingsView,
    pub(in crate::routes::assistant) assistant_model_ids: Option<Vec<String>>,
    pub(in crate::routes::assistant) latest: Option<AssistantLead>,
    pub(in crate::routes::assistant) handoffs: Vec<AssistantLeadView>,
    pub(in crate::routes::assistant) expected_handoff_status: &'static str,
    pub(in crate::routes::assistant) summary: Vec<AssistantIntentSummary>,
    pub(in crate::routes::assistant) key_group_options_result:
        Option<Result<Vec<AssistantKeyGroupOption>, String>>,
    pub(in crate::routes::assistant) key_group_calls: Arc<Mutex<Vec<String>>>,
    pub(in crate::routes::assistant) prepare_key_result:
        Option<Result<PreparedKeyAction, KeyCreationError>>,
    pub(in crate::routes::assistant) prepare_key_calls: Arc<Mutex<Vec<FixturePrepareKeyCall>>>,
    pub(in crate::routes::assistant) confirm_key_result:
        Option<Result<CreatedKey, KeyCreationError>>,
    pub(in crate::routes::assistant) confirm_key_calls: Arc<Mutex<Vec<FixtureConfirmKeyCall>>>,
    pub(in crate::routes::assistant) billing_result:
        Option<Result<AssistantBillingAccount, String>>,
    pub(in crate::routes::assistant) intent_calls: Arc<Mutex<Vec<(i64, String)>>>,
    pub(in crate::routes::assistant) cached_response: Option<AssistantCachedResponse>,
    pub(in crate::routes::assistant) stored_cache:
        Arc<Mutex<Vec<(String, AssistantCachedResponse, Duration)>>>,
    pub(in crate::routes::assistant) submit_result: Option<Result<AssistantLead, String>>,
    pub(in crate::routes::assistant) submit_calls: Arc<Mutex<Vec<FixtureSubmitCall>>>,
    pub(in crate::routes::assistant) resolve_result:
        Option<Result<AssistantLead, ResolveHandoffError>>,
    pub(in crate::routes::assistant) resolve_calls: Arc<Mutex<Vec<FixtureResolveCall>>>,
    pub(in crate::routes::assistant) audits: Arc<Mutex<Vec<AssistantAdminAudit>>>,
}

impl FixtureStore {
    pub(in crate::routes::assistant) fn with_key_groups(
        mut self,
    ...
    pub(in crate::routes::assistant) fn with_prepare_result(
        mut self,
    ...
    pub(in crate::routes::assistant) fn with_confirm_result(
        mut self,
    ...
    pub(in crate::routes::assistant) fn prepare_key_calls(
        &self,
    ) -> Arc<Mutex<Vec<FixturePrepareKeyCall>>> {
        Arc::clone(&self.prepare_key_calls)
    }

    pub(in crate::routes::assistant) fn confirm_key_calls(
        &self,
...
pub(in crate::routes::assistant) enum FixtureRateLimit {
    #[default]
    Allowed,
    Rejected(u64),
    Failed,
...
pub(in crate::routes::assistant) struct FixtureAuth {
    pub(in crate::routes::assistant) rate_limit: FixtureRateLimit,
}
...
pub(in crate::routes::assistant) struct FixtureUserRateLimiter {
    pub(in crate::routes::assistant) outcome: Result<CriticalRateLimitOutcome, ()>,
    pub(in crate::routes::assistant) calls: Arc<Mutex<Vec<(String, i64)>>>,
}

pub(in crate::routes::assistant) struct FixtureAgentBackend {
    pub(in crate::routes::assistant) responses:
        Mutex<VecDeque<Result<AssistantAgentTurnResponse, String>>>,
    pub(in crate::routes::assistant) turns: Arc<Mutex<Vec<AssistantAgentTurn>>>,
}
...
pub(in crate::routes::assistant) fn fixture_user(role: i64) -> DashboardUser {
    DashboardUser {
...
pub(in crate::routes::assistant) fn fixture_lead() -> AssistantLead {
    AssistantLead {
        id: 3,
        user_id: 7,
...
pub(in crate::routes::assistant) fn fixture_key_groups() -> Vec<AssistantKeyGroupOption> {
    vec![AssistantKeyGroupOption::selectable("default", "默认分组")]
}

pub(in crate::routes::assistant) fn fixture_router(store: FixtureStore) -> TestResult<Router> {
    fixture_router_with_auth(store, FixtureAuth::default())
}

pub(in crate::routes::assistant) fn fixture_router_with_auth(
    store: FixtureStore,
    auth: FixtureAuth,
) -> TestResult<Router> {
...
pub(in crate::routes::assistant) fn fixture_router_with_user_rate_limiter(
    store: FixtureStore,
...
pub(in crate::routes::assistant) fn fixture_router_with_dependencies(
    store: FixtureStore,
    auth: FixtureAuth,
...
pub(in crate::routes::assistant) fn fixture_router_with_agent(
    store: FixtureStore,
...
pub(in crate::routes::assistant) async fn response_json(response: Response) -> TestResult<Value> {
