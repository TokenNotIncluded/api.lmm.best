...
#[derive(Clone, Debug)]
pub(in crate::routes::assistant) struct AuthorizationFence {
    actor_id: i64,
...
impl AuthorizationFence {
    ...
    pub(in crate::routes::assistant) fn actor_id(&self) -> i64 {
        self.actor_id
    }

    pub(in crate::routes::assistant) fn actor_username(&self) -> &str {
        &self.actor_username
    }

    pub(in crate::routes::assistant) fn session_id(&self) -> &str {
        &self.session_id
    }

    pub(in crate::routes::assistant) fn expected_session_version(&self) -> i64 {
        self.expected_session_version
    }

    pub(in crate::routes::assistant) fn expected_user_auth_version(&self) -> i64 {
        self.expected_user_auth_version
    }

    pub(in crate::routes::assistant) fn developer_access_policy(
        &self,
...
pub(in crate::routes::assistant) struct ConfirmationToken(String);
...
pub(in crate::routes::assistant) struct PreparedKeyDraft {
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize)]
pub(in crate::routes::assistant) struct AssistantKeyGroupOption {
    pub(super) id: String,
...
impl AssistantKeyGroupOption {
    pub(in crate::routes::assistant) fn selectable(
        id: impl Into<String>,
    ...
    pub(in crate::routes::assistant) fn id(&self) -> &str {
        &self.id
    }
}

#[derive(Clone, Debug, PartialEq, Eq, Serialize)]
pub(in crate::routes::assistant) struct PreparedKeyAction {
    #[serde(rename = "type")]
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize)]
pub(in crate::routes::assistant) struct CreatedKey {
    pub(super) id: i64,
    pub(super) name: String,
    pub(super) group: String,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(in crate::routes::assistant) enum KeyCreationError {
