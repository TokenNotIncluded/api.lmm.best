//! Account-security and session routes.
//!
//! The listener-supplied [`SecurityAuthorizer`] owns identity decisions, while
//! mail, credential, and WebAuthn work stays behind [`SecurityProvider`]. The
//! in-memory provider is a test fake and refuses security-sensitive operations
//! instead of manufacturing a successful proof or credential.
