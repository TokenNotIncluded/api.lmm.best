...
//!
//! The normal listener composes the PostgreSQL/Valkey-backed read routes.
//! Operations without a production adapter remain unavailable.
...
impl PgObservabilityStore {
    ...
    async fn fetch_log_rows(
        ...
        // codeql[rust/cleartext-storage-database] -- SQL is an internal, parameterized template; all request values are bound below.
