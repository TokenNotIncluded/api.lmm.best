...
mod key_creation;
#[cfg(test)]
pub(in crate::migration_routes) mod pg_test_support;
mod secure_card;

pub(in crate::migration_routes) fn decrypt_assistant_secure_card_payload(
...
#[cfg(test)]
pub(in crate::migration_routes) fn encrypt_assistant_secure_card_fixture(
    session_secret: &SecretString,
    plaintext: &[u8],
) -> Result<String, ()> {
