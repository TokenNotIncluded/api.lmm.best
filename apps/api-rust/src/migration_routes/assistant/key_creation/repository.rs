...
use crate::migration_routes::assistant::secure_card::encrypt_payload;
use crate::migration_routes::identity_2fa::{
    CriticalTwoFactorVerification, verify_critical_mutation_factor,
};
use crate::migration_routes::missing_identity_catalog::{
    user_group_selection, user_group_selection_in_transaction,
};
...
pub(in crate::migration_routes::assistant) async fn load_pg_options(
...
pub(in crate::migration_routes::assistant) async fn prepare_pg(
    store: &PgAssistantReadStore,
    user_id: i64,
    session_id: &str,
...
pub(in crate::migration_routes::assistant) async fn confirm_pg(
    store: &PgAssistantReadStore,
