...
export const passkeyCopy = {
  ...
  zh: {
    ...
    'Remove {{name}}': '移除 {{name}}',
    'This Passkey will stop working for sign-in. Your other Passkeys will remain available.':
      '这把 Passkey 将无法再用于登录，其他 Passkey 仍可使用。',
  ...
  'zh-TW': {
    ...
    'Remove {{name}}': '移除 {{name}}',
    'This Passkey will stop working for sign-in. Your other Passkeys will remain available.':
      '這把 Passkey 將無法再用於登入，其他 Passkey 仍可使用。',
  ...
  ja: {
    ...
    'This Passkey will stop working for sign-in. Your other Passkeys will remain available.':
      'このパスキーではログインできなくなります。他のパスキーは引き続き使用できます。',
  ...
  ru: {
    ...
    'This Passkey will stop working for sign-in. Your other Passkeys will remain available.':
      'Этот ключ больше не позволит входить. Другие ключи доступа останутся доступны.',
  ...
  vi: {
    ...
    'This Passkey will stop working for sign-in. Your other Passkeys will remain available.':
      'Passkey này sẽ không thể dùng để đăng nhập. Các Passkey khác vẫn dùng được.',
    'e.g. Laptop or security key': 'Ví dụ: máy tính xách tay hoặc khóa bảo mật',
  },
}
