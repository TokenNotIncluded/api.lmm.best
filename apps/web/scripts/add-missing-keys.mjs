...
const uiDocTranslationFixes = {
  ...
  fr: {
    ...
    'Leave a short thank-you message': 'Laissez un court message de remerciement',
    ...
    'Move down': 'Descendre',
    'Move up': 'Monter',
    'No linked public channels yet.': 'Aucun canal public n’est encore associé.',
    ...
    'Confirmation {{current}} of {{total}}': 'Confirmation {{current}} / {{total}}',
  },
  ja: {
    ...
    'Move down': '下へ移動',
    'Move up': '上へ移動',
    'No linked public channels yet.': 'まだ公開チャンネルはリンクされていません。',
  ...
  ru: {
    ...
    'Confirmation {{current}} of {{total}}': 'Подтверждение {{current}} из {{total}}',
    ...
    'Leave a short thank-you message': 'Оставьте короткое сообщение с благодарностью',
  ...
  vi: {
    ...
    'No linked public channels yet.': 'Chưa có kênh công khai nào được liên kết.',
