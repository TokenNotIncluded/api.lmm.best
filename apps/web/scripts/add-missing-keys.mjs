...
const scriptsCopy = {
  en: {
    ...
    'Browse maintained setup scripts and copy the command for your system.': 'Browse maintained setup scripts and copy the command for your system.',
    ...
    'Scripts are read from this repository and exposed on the public scripts page.': 'Scripts are read from this repository and exposed on the public scripts page.',
    'Repository URL': 'Repository URL',
    Branch: 'Branch',
    'GitHub key (optional)': 'GitHub key (optional)',
    'Key is configured; leave blank to keep it': 'Key is configured; leave blank to keep it',
    'Only needed for a private repository': 'Only needed for a private repository',
    ...
    scripts: 'scripts',
    'Pull a repository to publish scripts.': 'Pull a repository to publish scripts.',
  ...
  zh: {
    ...
    'Public scripts': '公开脚本',
    'Back to home': '返回首页',
    'Browse maintained setup scripts and copy the command for your system.': '浏览维护中的安装脚本，复制适用于你系统的命令。',
    ...
    'Scripts are read from this repository and exposed on the public scripts page.': '脚本从此仓库读取，并展示在公开脚本页。',
    'Repository URL': '仓库地址',
    Branch: '分支',
  ...
  'zh-TW': {
    ...
    'Public scripts': '公開腳本',
    'Back to home': '返回首頁',
    'Browse maintained setup scripts and copy the command for your system.': '瀏覽維護中的安裝腳本，複製適用於你系統的指令。',
    ...
    'Scripts are read from this repository and exposed on the public scripts page.': '腳本從此儲存庫讀取，並顯示在公開腳本頁。',
  ...
  fr: {
    ...
    'Public scripts': 'Scripts publics', 'Back to home': "Retour à l'accueil", 'Browse maintained setup scripts and copy the command for your system.': 'Parcourez les scripts maintenus et copiez la commande adaptée à votre système.', 'Open public script page': 'Ouvrir la page des scripts publics', 'Unknown update time': 'Heure de mise à jour inconnue', fetches: 'récupérations', 'Command copied': 'Commande copiée', 'Unable to copy command': 'Impossible de copier la commande', 'No scripts published yet': 'Aucun script publié', 'Script repository': 'Dépôt de scripts', 'Scripts are read from this repository and exposed on the public scripts page.': 'Les scripts sont lus depuis ce dépôt et publiés sur la page publique.', 'Repository URL': 'URL du dépôt', Branch: 'Branche', 'GitHub key (optional)': 'Clé GitHub (facultative)', 'Key is configured; leave blank to keep it': 'Clé configurée ; laissez vide pour la conserver', 'Only needed for a private repository': 'Nécessaire uniquement pour un dépôt privé', 'Remove the stored GitHub key': 'Supprimer la clé GitHub enregistrée', 'Save repository': 'Enregistrer le dépôt', 'Pull updates': 'Récupérer les mises à jour', 'Copy public page link': 'Copier le lien public', 'Last pulled': 'Dernière récupération', 'Published scripts': 'Scripts publiés', scripts: 'scripts', 'Pull a repository to publish scripts.': 'Récupérez un dépôt pour publier des scripts.', 'Script repository settings saved': 'Configuration du dépôt enregistrée', 'Failed to pull repository': 'Échec de la récupération du dépôt', 'Scripts updated from repository': 'Scripts mis à jour depuis le dépôt', Saving: 'Enregistrement...', Pulling: 'Récupération...',
  },
  ja: {
    Scripts: 'スクリプト',
    ...
    'Public scripts': '公開スクリプト', 'Back to home': 'ホームに戻る', 'Browse maintained setup scripts and copy the command for your system.': '管理されているセットアップスクリプトを確認し、システム用のコマンドをコピーできます。', 'Open public script page': '公開スクリプトページを開く', 'Unknown update time': '更新時刻不明', fetches: '取得', 'Command copied': 'コマンドをコピーしました', 'Unable to copy command': 'コマンドをコピーできません', 'No scripts published yet': '公開スクリプトはありません', 'Script repository': 'スクリプトリポジトリ', 'Scripts are read from this repository and exposed on the public scripts page.': 'スクリプトはこのリポジトリから読み込まれ、公開ページに表示されます。', 'Repository URL': 'リポジトリ URL', Branch: 'ブランチ', 'GitHub key (optional)': 'GitHub キー（任意）', 'Key is configured; leave blank to keep it': 'キーは設定済みです。保持する場合は空欄にしてください', 'Only needed for a private repository': 'プライベートリポジトリの場合のみ必要です', 'Remove the stored GitHub key': '保存した GitHub キーを削除', 'Save repository': 'リポジトリを保存', 'Pull updates': '更新を取得', 'Copy public page link': '公開ページのリンクをコピー', 'Last pulled': '最終取得', 'Published scripts': '公開スクリプト', scripts: 'スクリプト', 'Pull a repository to publish scripts.': 'リポジトリを取得するとスクリプトが公開されます。', 'Script repository settings saved': 'スクリプトリポジトリ設定を保存しました', 'Failed to pull repository': 'リポジトリの取得に失敗しました', 'Scripts updated from repository': 'リポジトリからスクリプトを更新しました', Saving: '保存中...', Pulling: '取得中...',
  },
  ru: {
    Scripts: 'Скрипты',
    ...
    'Public scripts': 'Публичные скрипты', 'Back to home': 'На главную', 'Browse maintained setup scripts and copy the command for your system.': 'Просматривайте поддерживаемые скрипты установки и копируйте команду для своей системы.', 'Open public script page': 'Открыть страницу скриптов', 'Unknown update time': 'Время обновления неизвестно', fetches: 'загрузок', 'Command copied': 'Команда скопирована', 'Unable to copy command': 'Не удалось скопировать команду', 'No scripts published yet': 'Скрипты пока не опубликованы', 'Script repository': 'Репозиторий скриптов', 'Scripts are read from this repository and exposed on the public scripts page.': 'Скрипты читаются из этого репозитория и публикуются на открытой странице.', 'Repository URL': 'URL репозитория', Branch: 'Ветка', 'GitHub key (optional)': 'Ключ GitHub (необязательно)', 'Key is configured; leave blank to keep it': 'Ключ настроен; оставьте поле пустым, чтобы сохранить его', 'Only needed for a private repository': 'Нужен только для приватного репозитория', 'Remove the stored GitHub key': 'Удалить сохранённый ключ GitHub', 'Save repository': 'Сохранить репозиторий', 'Pull updates': 'Получить обновления', 'Copy public page link': 'Копировать ссылку', 'Last pulled': 'Последняя загрузка', 'Published scripts': 'Опубликованные скрипты', scripts: 'скриптов', 'Pull a repository to publish scripts.': 'Получите репозиторий, чтобы опубликовать скрипты.', 'Script repository settings saved': 'Настройки репозитория сохранены', 'Failed to pull repository': 'Не удалось получить репозиторий', 'Scripts updated from repository': 'Скрипты обновлены из репозитория', Saving: 'Сохранение...', Pulling: 'Загрузка...',
  },
  vi: {
    Scripts: 'Tập lệnh',
    ...
    'Public scripts': 'Tập lệnh công khai', 'Back to home': 'Về trang chủ', 'Browse maintained setup scripts and copy the command for your system.': 'Xem các tập lệnh cài đặt được duy trì và sao chép lệnh phù hợp với hệ thống của bạn.', 'Open public script page': 'Mở trang tập lệnh công khai', 'Unknown update time': 'Chưa biết thời gian cập nhật', fetches: 'lượt tải', 'Command copied': 'Đã sao chép lệnh', 'Unable to copy command': 'Không thể sao chép lệnh', 'No scripts published yet': 'Chưa có tập lệnh được công bố', 'Script repository': 'Kho tập lệnh', 'Scripts are read from this repository and exposed on the public scripts page.': 'Tập lệnh được đọc từ kho này và hiển thị trên trang công khai.', 'Repository URL': 'URL kho', Branch: 'Nhánh', 'GitHub key (optional)': 'Khóa GitHub (tùy chọn)', 'Key is configured; leave blank to keep it': 'Khóa đã được cấu hình; để trống để giữ nguyên', 'Only needed for a private repository': 'Chỉ cần cho kho riêng tư', 'Remove the stored GitHub key': 'Xóa khóa GitHub đã lưu', 'Save repository': 'Lưu kho', 'Pull updates': 'Kéo bản cập nhật', 'Copy public page link': 'Sao chép liên kết công khai', 'Last pulled': 'Lần kéo gần nhất', 'Published scripts': 'Tập lệnh đã công bố', scripts: 'tập lệnh', 'Pull a repository to publish scripts.': 'Kéo một kho để công bố tập lệnh.', 'Script repository settings saved': 'Đã lưu cài đặt kho tập lệnh', 'Failed to pull repository': 'Không thể kéo kho', 'Scripts updated from repository': 'Đã cập nhật tập lệnh từ kho', Saving: 'Đang lưu...', Pulling: 'Đang kéo...',
  },
}
