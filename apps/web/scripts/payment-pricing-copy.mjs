...
const values = {
  ...
  zh: [
    ...
    '基础价格未计入动态利润倍率和用量折扣。美元估算也未计入支付优惠和手续费，实付金额以结算报价为准。',
    '选择后获取报价',
  ...
  'zh-TW': [
    ...
    '基礎價格未計入動態利潤倍率和用量折扣。美元估算也未計入付款優惠和手續費，實付金額以結帳報價為準。',
    '選擇後取得報價',
  ...
  fr: [
    ...
    'Les prix de base excluent les multiplicateurs de marge dynamiques et les remises d’utilisation. Les estimations en USD excluent aussi les remises et frais de paiement ; le montant à régler est confirmé au paiement.',
  ...
  ja: [
    ...
    '基本価格には動的利益倍率と利用割引を含みません。米ドル概算にも支払い割引や手数料は含まれず、実際の支払額は決済時の見積もりで確定します。',
    '選択して見積もりを取得',
  ...
  ru: [
    ...
    'Базовые цены не включают динамические коэффициенты прибыли и скидки за использование. Оценки в USD также не включают платёжные скидки и комиссии; сумма к оплате подтверждается при оформлении.',
  ...
  vi: [
    ...
    'Giá cơ bản chưa gồm hệ số lợi nhuận động và giảm giá sử dụng. Ước tính USD cũng chưa gồm ưu đãi và phí thanh toán; số tiền phải trả được xác nhận khi thanh toán.',
    'Chọn để lấy báo giá',
