      ...
      <section className={cn('min-w-0', !compact && 'py-4')}>
        {!compact && (
          <div className='mb-3 flex items-center gap-2'>
            <span className='pricing-accent-badge inline-flex size-6 items-center justify-center'>
    ...
    <section className={cn('min-w-0', !compact && 'py-3 sm:py-4')}>
      {!compact && (
        <div className='mb-3 flex items-start gap-2 sm:mb-4'>
          <span className='pricing-accent-badge mt-0.5 inline-flex size-6 items-center justify-center'>
            <TagIcon className='size-3.5' />
          </span>
          <div>
            <div className='text-foreground text-base font-medium'>
        ...
        <div className={cn(compact ? cn(hasRules && 'mb-2') : 'mb-3 sm:mb-4')}>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isMatched && 'forge-price-matched-row'
                  )}
                >
                  <div className='mb-1.5 flex flex-wrap items-center gap-1.5'>
                    <Badge
                      variant='secondary'
                      className='forge-price-info-badge'
                    >
                    ...
                    {isMatched && (
                      <Badge
                        variant='secondary'
                        className='forge-price-success-badge'
                      >
                        {t('Matched')}
                      </Badge>
                    )}
          ...
          <StaticDataTable
            ...
            getRowClassName={(tier) => {
              ...
              return cn(isMatched && 'forge-price-matched-row')
            }}
            columns={[
              {
                id: 'tier',
              ...
              return (
                ...
                >
                  ...
                  <Badge
                    variant='secondary'
                    className={cn(
                      'forge-price-warning-badge shrink-0',
                      isMatched && 'forge-price-success-badge'
                    )}
                  >
