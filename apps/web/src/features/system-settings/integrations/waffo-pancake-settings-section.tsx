...
const DEFAULT_STORE_NAME = 'lmm-forge-store'
const DEFAULT_PRODUCT_NAME = 'lmm-forge-wallet-topup'
const DEFAULT_PAIR_NAME = `${DEFAULT_STORE_NAME} + ${DEFAULT_PRODUCT_NAME}`
  ...
  return (
    <div className='space-y-4 pt-4'>
      ...
      <div className='grid min-w-0 gap-x-5 gap-y-4 lg:grid-cols-2'>
        ...
        <div className='console-info-panel rounded-none p-4 text-sm lg:col-span-2'>
          <p className='mb-2 font-medium'>{t('Webhook Configuration:')}</p>
          <ul className='list-inside list-disc space-y-1'>
            <li>
              {t('Webhook URL (Test):')}{' '}
              <code className='console-info-code px-1 py-0.5 text-xs'>
        ...
        */}
        <div className='space-y-4 pt-2 lg:col-span-2'>
          ...
          {/*
            ...
            */}
          <div className='console-info-panel rounded-none p-3 text-xs'>
            ...
            <ul className='list-inside list-disc space-y-1'>
              <li>
                {t(
                  'The bound Store is the parent container for every Pancake product this platform creates from this admin — both the wallet top-up product and any subscription-plan products. One store is enough; pin a different one only if you genuinely run separate Pancake catalogs.'
                )}
              </li>
              <li>
                {t(
