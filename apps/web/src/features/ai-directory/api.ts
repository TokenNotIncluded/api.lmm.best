...
export const DEFAULT_AI_DIRECTORY_LINKS: AIDirectoryLink[] = [
  ...
  },
  {
    ...
    url: 'https://grok.com',
    category: 'chat',
    summary: "xAI's AI assistant",
    description: "Chat, search, and create with xAI's Grok web app.",
    enabled: true,
  },
  {
    id: 'deepseek',
  ...
  },
  {
    ...
    url: 'https://claude.ai',
    category: 'chat',
    summary: "Anthropic's AI assistant",
    description:
  ...
  },
  {
    ...
    category: 'research',
    summary: 'AI answers with sources',
    description: 'Research questions on the web and follow the cited sources.',
    enabled: true,
  },
  {
    id: 'codexreset',
  ...
  },
  {
    ...
    category: 'chat',
    summary: "Microsoft's AI assistant",
    description:
  ...
  },
  {
    ...
    category: 'chat',
    summary: "Moonshot AI's assistant",
    description:
  ...
  },
  {
    ...
    category: 'chat',
    summary: "Qwen's AI chat",
    description: 'Chat and create with the Qwen web app.',
    enabled: true,
  },
  {
    id: 'mistral',
    ...
    category: 'chat',
    summary: "Mistral's AI workspace",
    description: "Open Mistral's web workspace for chat and productivity.",
    enabled: true,
  },
  {
    id: 'huggingface',
