...
export const STATIC_I18N_KEYS = [
  ...
  'Deduction',
  'Account action',
  'Public page describing this site’s security rules.',
  'Require login to view security page',
  ...
  'Local guardrail fee',
  'Matches by risk category',
  'No category statistics are available yet.',
  'No public risk categories are available yet.',
  'No public rule summaries are available yet.',
  'No public violation fee rules are published yet.',
  'Not retryable',
  ...
  // Open-source bounties (configuration-driven labels and API error mappings)
  'Draft',
  'Published',
  'Paused',
  'Completed',
