...
function Menubar({ className, ...props }: MenubarPrimitive.Props) {
  return (
    <MenubarPrimitive
      data-slot='menubar'
      className={cn(
        'flex items-center gap-0.5 h-9 rounded-3xl border p-1',
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        'flex items-center outline-hidden select-none hover:bg-muted aria-expanded:bg-muted rounded-2xl px-2 py-0.75 text-sm font-medium',
        className
      )}
      {...props}
    />
...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'dark data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 bg-popover text-popover-foreground ring-foreground/5 dark:ring-foreground/10 min-w-48 rounded-3xl p-1.5 shadow-lg ring-1 duration-100 motion-reduce:animate-none',
        className
      )}
      {...props}
    />
...
function MenubarLabel({
  ...
  return (
    <DropdownMenuLabel
      ...
      data-inset={inset}
      className={cn(
        'font-medium text-muted-foreground px-3.5 py-2.5 text-xs data-inset:pl-9.5',
        className
      )}
      {...props}
    />
...
function MenubarShortcut({
  ...
  return (
    <DropdownMenuShortcut
      ...
      className={cn(
        'ml-auto text-muted-foreground group-focus/menubar-item:text-accent-foreground text-xs tracking-widest',
        className
      )}
      {...props}
    />
