...
export const SIDEBAR_ROUTE_SECTION: Readonly<Record<string, string>> = {
  ...
  '/keys': 'developer',
  '/drawing': 'general',
  '/remote-control': 'developer',
  '/usage-logs/common': 'developer',
  '/usage-logs/task': 'developer',
  '/wallet': 'personal',
  '/company': 'personal',
  '/profile': 'personal',
  '/support': 'personal',
...
> = {
  ...
  '/tool-market': { section: 'personal', module: 'personal' },
  '/channels': { section: 'admin', module: 'channel' },
  '/models/metadata': { section: 'admin', module: 'models' },
  '/users': { section: 'admin', module: 'user' },
  '/redemption-codes': { section: 'admin', module: 'redemption' },
  '/red-packets': { section: 'admin', module: 'redemption' },
